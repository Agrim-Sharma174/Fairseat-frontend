    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          <h1
            className={`${montserrat.className} text-2xl font-bold text-center mb-8`}
          >
            Your Ticket
          </h1>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                <h2
                  className={`${montserrat.className} text-xl font-bold mb-1`}
                >
                  {event.title}
                </h2>
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className={`${firaCode.className} text-sm font-medium`}>
                      {ticketId}
                    </p>
                  </div>
                  <div>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-6 mb-8">
            <h3
              className={`${montserrat.className} text-lg font-semibold mb-4 flex items-center gap-2`}
            >
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-400 mt-0.5">
                  ✓
                </div>
                <span className={`${raleway.className} text-gray-300`}>
                  This ticket is secured by blockchain technology and cannot be
                  duplicated.
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span className={`${raleway.className} text-gray-300`}>
                  Your ticket includes a digital collectible NFT that will be
                  sent to your wallet.
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className={`${raleway.className} text-gray-300`}>
                  Download this ticket or take a screenshot to ensure you have
                  access even without internet.
                </span>
              </li>
            </ul>
          </div>
