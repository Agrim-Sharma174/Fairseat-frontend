      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          {FAQs.map((faq, index) => (
            ...
            >
              <AccordionTrigger className="hover:no-underline py-6 text-left px-6 text-lg">
                {faq.question}
              </AccordionTrigger>
              <AccordionContent className="text-gray-300 bg-[#161C21] p-6 text-lg">
                {faq.answer}
              </AccordionContent>
            </AccordionItem>
          ))}
        ...
        <div className="text-center mt-20 space-y-4">
          <h3 className="text-3xl md:text-3xl lg:text-5xl font-thin bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent">
