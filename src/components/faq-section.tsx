    ...
    <div className="min-h-screen text-white py-12 sm:py-16">
      <div className="container mx-auto px-4">
        ...
        <Accordion type="single" collapsible className="space-y-3 sm:space-y-4">
          {FAQs.map((faq, index) => (
            ...
            >
              ...
              <AccordionContent className="text-[#FFFFFFB2] bg-[#161C21] p-4 sm:p-6 text-base sm:text-lg rounded-b-lg">
                {faq.answer}
              </AccordionContent>
            </AccordionItem>
          ))}
        ...
        <div className="text-center mt-12 sm:mt-20 space-y-4">
          ...
          <p className="text-[#FFFFFFB2] max-w-2xl mx-auto text-sm sm:text-base">
