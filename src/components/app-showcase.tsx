    ...
    <section className="py-24 bg-gradient-to-b from-gray-950 to-teal-950">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-5xl mx-auto h-[600px]">
          {/* Left Phone */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[280px] h-[560px] transform ">
          ...
          {/* Center Phone */}
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/3 w-[280px] h-[560px] z-10">
          ...
          {/* Right Phone */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[280px] h-[560px] transform">
            <div className="w-full h-full rounded-[3rem] border-8 border-gray-800 overflow-hidden">
              <Image
                src={iphone3}
